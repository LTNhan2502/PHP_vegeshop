		...
		<div class="hero-wrap hero-bread" style="background-image: url('Content/images/bg_1.jpg');">
			<div class="container">
				...
				<div class="col-md-9 ftco-animate text-center">
					...
					<h1 class="mb-0 bread">products
						<?php
							// if($ac = 1){
							// 	echo 'All Products';
							// }
							// if($ac = 2){
							// 	echo 'All Sale Products';
							// }
							// if($ac = 3){
							// 	echo 'Search Results';
							// }
	...
	<?php
		$ac =1;
		if(isset($_GET['act'])){
			if(isset($_GET['act']) && isset($_GET['act'])=="sanphamkhuyenmai"){
				$ac = 2;
			}
			elseif(isset($_GET['act']) && isset($_GET['act']) == 'timkiem'){
				$ac = 3;
			}
			else{
				$ac= 1;
    	...
    	<div class="container">
    		<div class="row justify-content-center">
    			<div class="col-md-10 mb-5 text-center">
    				<ul class="product-category">
    					<li><a href="index.php?action=sanpham" class="active">All</a></li>
    					<li><a href="index.php?action=loai&act=vegetables">Vegetables</a></li>
    					<li><a href="index.php?action=loai&act=fruits">Fruits</a></li>
    		...
    		<div class="row">
				<?php
					$hh = new hanghoa();
					if($ac == 1){
						// $result = $hh->getHanghoaAll();  12 sản phẩm
			...
			<div class="col text-center">
				...
				<ul>
					<?php
						...
						for($i=1; $i<=$page;$i++):
					?>					
					<li><span><a href="index.php?action=sanpham&page=<?php echo $i; ?>"><?php echo $i; ?></a></span></li>
					<?php
						endfor;
