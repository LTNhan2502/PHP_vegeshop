...
switch ($act) {
    ...
    case 'forget_action':
        if (isset($_POST['submit_email'])) {
            ...
            if ($checkuser > 0) {
                ...
                $mail->Username = "letrongnhan2502@gmail.com"; //
                // GMAIL password
                // $mail->Password = "php22023ngoc";
                $mail->Password = "kvox zsxc gtox epzy"; //Phplytest20@php
                $mail->SMTPSecure = "tls";  // ssl
                // sets GMAIL as the SMTP server
                $mail->Host = "smtp.gmail.com";
                // set the SMTP port for the GMAIL server
                $mail->Port = "587"; // 465
                $mail->From = 'letrongnhan2502@gmail.com';
                $mail->FromName = 'Ly';
    ...
    case 'resetpass':
        ...
        if(isset($_POST['submit_password'])){
            $pass = $_POST['password']; //187796
            //Dò lại trong session, đối tượng nào có pass giống với pass trên
